...
%s    |    |__(  <_> )  \___|    <  |  |   | \_\ \\
    |_______ \____/ \___  >__|_ \ |__|   |___  /
            \/          \/     \/            \/ 
 [*] ----------------------------------------------
 [*] Gitbub      : https://github.com/AKKUSANTUY
 [*] Facebook    : https://www.facebook.com/BUKAN.HACKER.CUK
 [*] Instagram   : @Akku_Santuy
 [*] WhatsApp    : +62 821-3456-6596
 [*] ----------------------------------------------\n"""% (m,h,m,p)
def aahh(s):
    for c in s + '\n':
        sys.stdout.write(c)
...
%s    |    |__(  <_> )  \___|    <  |  |   | \_\ \\
 ...
 [*] ----------------------------------------------\n"""% (m,h,m,p)
	print(logo)
	print("     %s     [ %sYour Facebo ok Login Cookies %s]" % (k,h,k) )
